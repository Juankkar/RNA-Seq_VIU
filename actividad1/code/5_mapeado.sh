...
then
   ...
   hisat2 -k2 -U ../data/processed/ejercicio2_trimmed/SRR13795616_trimmed.fq.gz -x ../data/reference_genome/genome --rna-strandness R -S ../results/mapeado/replica_hisat2.sam
else
