...
## Esto nos lo dio la profesora, no me acuerdo muy bien de donde sale
...
## tercer apartado
png(file="results/data_analysis/plots/plotmds.png")
...
for (plot in 1:length(list_exp_diff)){
    ...
    png(glue("results/data_analysis/plots/hist{plot}.png"))
    hist(list_exp_diff[[plot]], 
...
png("results/data_analysis/plots/plotsmear_IvsH.png")
plotSmear(y, cex = .5)
...
png("results/data_analysis/plots/plotsmear_detags_IvsH.png")
...
png("results/data_analysis/plots/plotsmear_detags_IvsIT.png")
...
# Vennplot
png("results/data_analysis/plots/venn_plot.png")
...
png("results/data_analysis/plots/upset_plot.png")
...
for(i in c("complete", "average")){
  png(glue("results/data_analysis/{i}_cluster_heatmap.png"))
  heat_map <- pheatmap(
...
png("results/data_analysis/plots/barplot_kegg.png")
barplot(kegg)